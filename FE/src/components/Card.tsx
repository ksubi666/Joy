...
const Card = ({
  ...
  return (
    <div className="p-20 ">
      <div className="border-[1px] rounded-xl w-[280px] flex flex-col items-center justify-center ">
        <div className="w-[280px] h-[280px] relative rounded-t-xl overflow-hidden">
          <Image
